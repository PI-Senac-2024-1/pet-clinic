        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-5 text-center mx-auto">
                    <h1 class="text-white mb-2 mt-5">Welcome to PetClinic Finder!</h1>
                    <p class="text-lead text-white">Create your account and find Veterinary Care in your region.</p>
                </div>
            </div>
        </div>
    </div>
